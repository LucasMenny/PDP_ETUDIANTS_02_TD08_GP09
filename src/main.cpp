...
#define TEMPERATURE "TD08_GP09/temp"
#define HUMIDITE "TD08_GP09/relhum"



const char* wifi_ssid = "iphone_de_adam";
const char* wifi_password = "adamhassan";
...
const char* client_id = "TD08_GP09";
...
void setup() {
 ...
 client.setCACert(ca_cert);
  ...
  {
    mqtt_client.publish("TD08_GP09/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD08_GP09/relhum", String(relative_humidity_measure).c_str());
  }
